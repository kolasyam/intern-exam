...
const Sidebar = () => {
  ...
  return (
    <>
      <button
        className={`fixed top-4 left-4 p-4 rounded-full bg-blue-500 text-white hover:bg-blue-600 md:hidden`}
        onClick={() => setIsSidebarOpen(!isSidebarOpen)}
      >
        <RxHamburgerMenu size={24} />
      </button>
      <div className="relative w-[20%] md:block hidden">
        <aside
        ...
        >
          <div>
            ...
            <nav className="mt-4 space-y-2 w-full px-4">
              ...
              <button className="flex items-start justify-center p-3 rounded-lg text-[#f87171] hover:bg-[rgba(175,121,116,1)] hover:text-white transition-colors w-full">
...
//         className="md:hidden p-3 text-gray-700 absolute bottom-4 right-4"
//       >
//         <RxHamburgerMenu size={24} />
//       </button>
